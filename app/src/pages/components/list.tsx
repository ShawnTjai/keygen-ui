...
export const ComponentList: React.FC = () => {
    const columns = React.useMemo<ColumnDef<IComponent>[]>(
        () => [
            {
                id: "actions",
                header: "Actions",
            ...
            },
            {
                ...
                cell: function render({ getValue, table }) {
                    ...
                    return machine ? <Link to={`/machines/show/${id}`} className={classes.listLink}>{machine?.attributes.fingerprint}</Link> : "Loading...";
                },
            },
            {
                id: "fingerprint",
